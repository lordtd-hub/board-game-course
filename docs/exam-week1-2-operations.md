...
4. เลือกเวลาปิดรับนักศึกษาเข้า แล้วกด **เปิดรับเข้าสอบตอนนี้**
5. กด **คัดลอกลิงก์** เพื่อส่งผ่าน LINE, Google Classroom หรือทำ QR
6. แจ้งรหัสห้องแยกจากลิงก์เมื่อทุกคนอยู่ในห้องสอบแล้ว

เวลาปิดรับเข้าเป็นเพียงเวลาสุดท้ายที่นักศึกษาเริ่มสอบได้ ผู้ที่เริ่มแล้วจะมีเวลาทำข้อสอบครบ 60 นาทีจากเวลาเริ่มของตนเอง
